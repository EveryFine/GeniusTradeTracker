...
class StockFundIndustryDetailIntradayBase(SQLModel):
...
class StockFundIndustryDetailIntraday(StockFundIndustryDetailIntradayBase, table=True):
    """stock_fund_industry_detail_intraday表"""
    __tablename__ = "stock_fund_industry_detail_intraday"
    id: int | None = Field(default=None, primary_key=True, description='id')


class StockFundIndustryDetailIntradayCreate(StockFundIndustryDetailIntradayBase):
    pass


class StockFundIndustryDetailIntradayPublic(StockFundIndustryDetailIntradayBase):
    id: int


class StockFundIndustryDetailIntradayAllPublic(SQLModel):
    data: list[StockFundIndustryDetailIntradayPublic]
    count: int