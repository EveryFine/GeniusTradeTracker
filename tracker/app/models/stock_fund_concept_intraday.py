...
class StockFundConceptIntradayBase(SQLModel):
    ...
    change_rate: float | None = Field(default=None, description='概念涨跌幅')
    change_rate_rank: float | None = Field(default=None, description='概念涨跌幅排名')
...
class StockFundConceptIntraday(StockFundConceptIntradayBase, table=True):
    """stock_fund_concept_intraday表"""
    __tablename__ = "stock_fund_concept_intraday"
    id: int | None = Field(default=None, primary_key=True, description='id')


class StockFundConceptIntradayCreate(StockFundConceptIntradayBase):
    pass


class StockFundConceptIntradayPublic(StockFundConceptIntradayBase):
    id: int


class StockFundConceptIntradayAllPublic(SQLModel):
    data: list[StockFundConceptIntradayPublic]
    count: int
