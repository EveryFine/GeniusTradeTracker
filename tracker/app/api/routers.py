...
v1.include_router(stock_fund_single_detail_intraday.router, prefix='/fund_single_detail_intraday', tags=['资金流--个股--详细--即时'])

v1.include_router(stock_fund_single_detail_rank.router, prefix='/fund_single_detail_rank', tags=['资金流--个股--详细--排行'])
