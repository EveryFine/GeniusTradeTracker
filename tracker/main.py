...
from app.task.stock_zh_a_spot_sina_realtime_task import execute_create_stock_zh_a_spot_sina_realtime
...
def init_scheduler():
    ...
    scheduler.add_job(execute_create_stock_history_bao_k_1000_2000, 'cron', hour=1, minute=0, second=0)
    scheduler.add_job(execute_create_stock_history_bao_k_2000_3000, 'cron', hour=2, minute=30, second=0)
    scheduler.add_job(execute_create_stock_history_bao_k_3000_4000, 'cron', hour=4, minute=0, second=0)
    ...
    # 东方财富-概念板块-成分股
    scheduler.add_job(execute_create_stock_board_concept_cons_em, 'cron', hour=17, minute=52, second=0)
    scheduler.add_job(execute_create_stock_board_concept_cons_em, 'cron', hour=19, minute=35, second=0)
    scheduler.add_job(execute_create_stock_board_concept_cons_em, 'cron', hour=21, minute=58, second=0)
