...
def init_scheduler():
    ...
    # 历史行情 - BaoStock 不复权
    scheduler.add_job(execute_create_stock_history_bao_k_0_1000, 'cron', hour=10, minute=15, second=0)
    ...
    scheduler.add_job(execute_create_stock_history_bao_k_4000_5000, 'cron', hour=21, minute=30, second=0)
